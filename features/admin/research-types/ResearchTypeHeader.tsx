...
import CreateCategoryForm from './CreateResearchTypeForm'
import { Search } from 'lucide-react'

const ResearchTypeHeader = ({ onSearch }: { onSearch: (value: string) => void }) => {
  ...
  return (
    <div className="flex items-center justify-between gap-4 ">
      <div className="relative flex-1 max-w-md">
        ...
        <Input
          placeholder="Search by research type name..."
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent>
              <DialogHeader className="sr-only">
                <DialogTitle>Add Research Type</DialogTitle>
              </DialogHeader>
...
export default ResearchTypeHeader